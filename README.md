...
## ソリューションファイルの作成
.\CmnClsLib\CmnClsLib.slnx
```xml
<Solution>
  <Project Path="CmnClsLib/CmnClsLib.csproj" />
</Solution>
```

## プロジェクトファイルの修正
.\CmnClsLib\CmnClsLib\CmnClsLib.csproj
```xml
...
# 単体テスト
dotnet test .\CmnClsLib\TestProject1\TestProject1.csproj
```
